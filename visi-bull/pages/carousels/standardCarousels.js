function standardCarousel(items)
{
    /***************************
    ...
    ***************************/
    var width = null,  // The width of the carousel.
        ...
        itemSnapSpeed = 500,  // The duration that the items take when snapping back into place.
    ...
    *****************************/
    function carousel(selection)
    {
        ...
        var dragBehaviour = d3.behavior.drag()
            ...
            .on("dragend", drag_end);
        if (isInfinite) { dragBehaviour.on("drag", drag_update_infinite); }
        else { dragBehaviour.on("drag", drag_update_noninfinite); }
